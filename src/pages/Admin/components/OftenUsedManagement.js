...
import OftenUsedManage from './OftenUsedManage';
import PatternUpload from './PatternUpload';

function OftenUsedManagement() {
	/*------------------------------*/
		...
		<div className="c-admin-patterns">
			...
			<div className="c-admin-patterns__content">
				<Switch>
					...
					<Route path={`${url}/manage`} component={() => <OftenUsedManage patterns={patterns}/>} />
...
export default OftenUsedManagement;
