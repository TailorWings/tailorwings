...
export const MSMT_METHODS = [
	...
	{
		name: 'Measure Online',
		desc: 'measurement.measureOnline.subTitle',
		buttonText: 'measurement.measureOnline.buttonText',
		// nameVN: 'Đo online',
	...
	{
		name: 'Standard Size',
		desc: 'measurement.standardSize.subTitle',
		buttonText: 'measurement.standardSize.buttonText',
		// nameVN: 'Size chuẩn',
...
export const MEASUREMENTS_STYLES = {
	...
	'pantsskirtlength': {
		id: 'pantsskirtlength',
		label: 'Pants/ Skirt Length',
		guide: pantLength,
		labelVN: 'Dài Quần/ Chân Váy',
...
export const ONLINE_MEASUREMENTS = [
	{
		...
		msmts: [
			...
			MEASUREMENTS_STYLES['shirtdresslength'],
	...
	},
	{
		...
		msmts: [
			...
			MEASUREMENTS_STYLES['hip'],
			MEASUREMENTS_STYLES['crothdepth'],
			MEASUREMENTS_STYLES['pantsskirtlength'],
			MEASUREMENTS_STYLES['thigh'],
			MEASUREMENTS_STYLES['highhip'],
		],
	},
